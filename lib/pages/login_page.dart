...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        //frase inicial centrado y color de fondo universal
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                //ubicacion y tamaño de la letra
                SizedBox(
                  height: 35.0,
                ),
...
//retornar widget de forma ordenada, se detecta mas facilmente errores
  //primera caja de texto
  Widget _textFieldName() {
    return _textFieldGeneral(
      labelText: 'Nombre',
      hintText: 'Camilo Trejos',
